	...
	<div class="container">
		<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							...
							<%-- 크로스 사이트 스크립팅(XSS) 악성 코드 사용 방지법. 글 제목에 <script> 태그로 alert를 넣으면 팝업이 뜸 --%>	
							<td colspan="2" style="text-align: left;"><%= bbs.getBbsTitle().replaceAll(" ", "&nbsp").replaceAll("<", "&lt;").replaceAll(">", "&gt").replaceAll("\n", "<br>") %></td>	
						</tr>
						<tr>
							<td>작성자</td>	
				...
				%>
					...
					<a class="btn btn-primary" onClick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%= bbsID %>">삭제</a>
				<%			
					}
				%>
